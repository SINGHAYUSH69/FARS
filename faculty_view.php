    ...
    <header class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
            <h2 class="text-lg font-semibold text-gray-800">
                Faculty Profile: <?php echo htmlspecialchars($faculty['first_name'] . ' ' . $faculty['last_name']); ?>
            </h2>
            <div>
                <a href="faculty_edit.php?id=<?php echo $faculty_id; ?>" class="bg-indigo-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-indigo-700 mr-2">
                    Edit Profile
                </a>
                <a href="faculty.php" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-300">
                    Back to List
                </a>
            </div>
        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div id="development-tab" class="tab-content hidden">
                            ...
                            <?php if (empty($promotions) && empty($workshops)): ?>
                                ...
                                <div class="mt-4">
                                    <a href="workshop_register.php" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 mr-2">
                                        Register for Workshop
                                    </a>
                                    <a href="promotion_request.php?faculty_id=<?php echo $faculty_id; ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700">

...
<head>
    ...
    <style>
        ...
        animation: flowing-wave 15s ease infinite;
    }
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="p-8 md:p-12">
                <div class="mb-10 text-center">
                    ...
                    <h1 class="mt-6 text-3xl font-bold text-gray-100">Admin Portal</h1>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="space-y-6">
                    ...
                    <div>
                        <div class="flex justify-between mb-2">
                            ...
                            <a href="faculty_login.php" class="text-sm text-indigo-400 hover:text-indigo-300">Faculty Login</a>
                        </div>

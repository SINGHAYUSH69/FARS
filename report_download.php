    ...
    switch ($reportType) {
        case 'faculty':
            ...
            $sql = "SELECT 
                    ...
                    JOIN evaluations e on e.faculty_id=f.faculty_id
                                ...
                                try {
                                    ...
                                    if (count($facultyData) > 0) {
                                        foreach ($facultyData as $faculty) {
                                            ...
                                            echo '<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">' . ucfirst(htmlspecialchars($faculty['Score']?$faculty['Score']:' ')) . '</td>';
